...
globalStyle.textContent = `
  *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
  ...
  @media (max-width:768px) {
    ...
    .img-order-1{order:1!important;aspect-ratio:16/9!important}
    .img-order-2{order:2!important}
  }
  @media (max-width:480px) {
    .data-grid{grid-template-columns:1fr 1fr!important}
    .anggota-flex{flex-direction:column!important;align-items:center!important}
  }
    ...
    <section ref={heroRef} id="hero" style={{position:"relative",minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden",width:"100%",maxWidth:"100vw"}}>
      ...
      <div className="hero-scroll-cue" style={{position:"absolute",bottom:"2rem",left:"50%",transform:"translateX(-50%)",display:"flex",flexDirection:"column",alignItems:"center",gap:"6px",opacity:0}}>
        ...
        <div style={{position:"relative",width:"1px",height:"36px",overflow:"hidden"}}>
          ...
          {/* shimmer */}
          <div style={{position:"absolute",top:0,left:0,width:"100%",height:"100%",background:"linear-gradient(to bottom,transparent,rgba(255,255,255,.6),transparent)",animation:"shimmer 2s infinite"}}/>
        </div>
      </div>
    </section>
  );
  ...
  return (
    <motion.section initial={{opacity:0}} whileInView={{opacity:1}} viewport={{once:true,amount:0.3}}
      ...
      <div style={{maxWidth:"680px",margin:"0 auto",textAlign:"center"}}>
        ...
        <div className="anggota-flex" style={{display:"flex",gap:".75rem",justifyContent:"center",flexWrap:"wrap",marginTop:"1.2rem"}}>
          {members.map(([name,num],i)=>{
            const {ref,x,y}=useMagnetic(0.25);
            return (
              <motion.div key={i} ref={ref} style={{x,y,display:"flex",alignItems:"center",gap:"10px",background:"#1F1A14",border:"1px solid rgba(200,151,42,.2)",borderRadius:"50px",padding:"8px 20px 8px 10px",cursor:"default"}}
                initial={{opacity:0,y:20}} whileInView={{opacity:1,y:0}} transition={{delay:i*.15}} viewport={{once:true}}
...
function ImageSection({ id, title, imgSrc, imgAlt, children, reverse=false, bg="#0D0B09" }) {
  ...
  return (
    <section id={id} ref={el=>{ref.current=el;sectionRef.current=el;}}
      style={{padding:"clamp(3rem,6vw,5rem) clamp(1rem,4vw,1.5rem)",background:bg,borderBottom:"1px solid rgba(200,151,42,.15)"}}>
      <div className="img-grid" style={{maxWidth:"960px",margin:"0 auto",display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 1fr",gap:isMobile?"1.5rem":"3rem",alignItems:"center"}}>
        ...
        {/* foto dengan clip-path reveal + parallax */}
        <motion.div
...
/* ════════════ TIMELINE ════════════ */
const TL_DATA=[
  {year:"Mei 1998",label:"Tragedi Kekerasan Seksual & Pembentukan TGPF",open:true,
    paras:["Pada 13–15 Mei 1998, di tengah kerusuhan massal yang mengiringi jatuhnya rezim Soeharto, terjadi kekerasan seksual sistematis terhadap perempuan keturunan Tionghoa di Jakarta (Glodok, Pantai Indah Kapuk, Kelapa Gading), Solo, Medan, Palembang, dan Surabaya.","Pemerintah B.J. Habibie membentuk Tim Gabungan Pencari Fakta (TGPF) melalui Keppres No. 181/1998. TGPF bekerja 5 bulan dan memverifikasi 85 korban perkosaan (termasuk 24 yang meninggal) serta ratusan kasus lainnya.","Laporan TGPF merekomendasikan pengadilan HAM ad hoc dan rehabilitasi korban. Namun rekomendasi ini tidak pernah ditindaklanjuti. Hingga 2026, tidak satu pun pelaku yang diadili."]},
  {year:"Oktober 1998 – 2000",label:"Lahirnya Komnas Perempuan & CATAHU",
    paras:["Komnas Perempuan dibentuk melalui Keppres No. 181 Tahun 1998 sebagai respons langsung terhadap tragedi Mei 1998, menjadi lembaga negara pertama yang menangani kekerasan berbasis gender.","Sejak 2001, Komnas Perempuan menerbitkan CATAHU sebagai alat advokasi dan dokumentasi komprehensif kasus kekerasan terhadap perempuan di Indonesia."]},
  {year:"2000 – 2016",label:"Advokasi Panjang & Inisiasi RUU",
    paras:["Selama lebih dari satu dekade, organisasi perempuan dan aktivis HAM terus mendorong pengakuan hukum atas kekerasan seksual. KUHP dinilai tidak memadai melindungi korban.","Pada 2012, Komnas Perempuan mulai menyusun draf RUU PKS yang mencakup 15 bentuk kekerasan seksual yang sebelumnya tidak diakui secara hukum."]},
  {year:"2016 – 2022",label:"Pertarungan Legislasi RUU PKS",
    paras:["RUU PKS masuk Prolegnas 2016, namun menghadapi penolakan keras. Pada 2020, DPR mengeluarkannya dari Prolegnas prioritas — kemunduran besar bagi gerakan perempuan.","Kampanye #GerakMelawan memaksa DPR memasukkan kembali sebagai RUU TPKS. Pada 12 April 2022, UU TPKS akhirnya disahkan setelah perjuangan hampir satu dekade."]},
  {year:"2022 – 2026",label:"Implementasi UU TPKS & Tantangan Saat Ini",
    paras:["Meski UU TPKS disahkan, implementasinya masih menghadapi hambatan. PP turunan belum sepenuhnya diterbitkan dan aparat penegak hukum masih perlu pelatihan khusus.","CATAHU 2024 mencatat lebih dari 400.000 kasus kekerasan terhadap perempuan. Hingga 2026, para penyintas tragedi Mei 1998 masih menunggu keadilan."]},
];
